...
class CRC16M {
	...
	public static void main(String[] args) {
		...
		String code = "010300090002";//读寄存器的值
		//code = "0106FA011770";//写单寄存器值
		//code = "0110000900020442C80000";//写寄存器(n > 0)的值
		//code = "000000000006010340000002";
		byte[] sbuf = CRC16M.getSendBuf(code);
		System.out.println("数据:    "+ code);
		
		String str_sbuf = CRC16M.getBufHexStr(sbuf);
		System.out.println("校验为:  "+ str_sbuf.substring(str_sbuf.length()-4));
		System.out.println("组合数据:"+str_sbuf);
	}
